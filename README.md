...
cannot arise. All are GPL-3.0-only, and every release publishes a `.sha256` beside the APK.

| | | |
|---|---|---|
| [**Messaging**](https://github.com/wanderwildwood/kotozute) | SMS and MMS, and a page your phone serves to your own computer so you can text from a keyboard | [APK](https://github.com/wanderwildwood/kotozute/releases/latest/download/kotozute.apk) |
...
Three are written from scratch; three are forks, and say whose work they continue. Each
